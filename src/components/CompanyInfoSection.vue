  ...
  <div class="section bg-dark-gray wf-section">
    ...
    <div class="container">
      <div class="w-layout-grid main-grid">
        ...
        >
          <h2 class="heading-large margin-bottom-xsmall">Speakers.</h2>
          <p class="medium-paragraph">
            Stay tuned for more speaker announcements in the coming months.
          </p>
        </div>
      </div>
    </div>
        ...
        <div role="list" class="collection-list-col w-dyn-items">
          ...
          >
            <a
              ...
              href="https://friday-template.webflow.io/speakers/james-hetfield"
              ...
              >
                <div class="overflow">
                  ...
                  >
                    <div
                      class="s-ticker-flex"
                      style="
                        transform: translate3d(-38.47%, 0px, 0px)
                ...
                <div class="overflow">
                  ...
                  >
                    <div
                      style="
                        transform: translate3d(-61.53%, 0px, 0px)
                          scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg)
                          rotateZ(0deg) skew(0deg, 0deg);
                        transform-style: preserve-3d;
                        will-change: transform;
              ...
              <img
                src="/assets/61fdc09d23a662eecb14d82a_portrait-happy-smiley-man.jpg"
                loading="lazy"
                alt=""
          ...
          >
            <a
              data-w-id="6e7598f0-4ae8-b765-38bc-ef4f35557c21"
              href="https://friday-template.webflow.io/speakers/ada-lovelace"
              class="link-block w-inline-block"
              ><div
                data-w-id="6e7598f0-4ae8-b765-38bc-ef4f35557c23"
                style="
                  background-color: rgb(222, 50, 7);
                  transform: translate3d(0px, 102%, 0px) scale3d(1, 1, 1)
                    rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg);
                  transform-style: preserve-3d;
                "
              ...
              >
                <div class="overflow">
                  ...
                  >
                    ...
                    >
                      <div
                        style="color: hsla(29, 100%, 50%, 1)"
                        class="heading-large no-wrap"
                      >
                        Ada Lovelace
                      </div>
                      <div
                        style="background-color: hsla(29, 100%, 50%, 1)"
                        class="dot-divider"
                      ></div>
                    </div>
                    <div
              ...
              <img
                src="/assets/61fdc0a871a096ee4ef00abd_portrait-good-.jpg"
                loading="lazy"
                alt=""
                class="cover-image relative"
            /></a>
          ...
          >
            <a
              data-w-id="6e7598f0-4ae8-b765-38bc-ef4f35557c21"
              href="https://friday-template.webflow.io/speakers/tiffany-tattum"
              class="link-block w-inline-block"
              ><div
                data-w-id="6e7598f0-4ae8-b765-38bc-ef4f35557c23"
                style="
                ...
                <div class="overflow">
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        style="background-color: hsla(24, 92.88%, 69.44%, 1)"
                        class="dot-divider"
                      ></div>
                    </div>
                    <div
              ...
              <img
                src="/assets/61fdc767a1b84ad984911b54_pretty-smiling-joyfully-female-with-fair-hair-dressed-casually-looking-with-satisfaction.jpg"
                loading="lazy"
                alt=""
                class="cover-image relative"
            /></a>
    ...
    <div class="container padding-bottom-medium">
      <div class="flex center">
        <div
          data-w-id="7eba1b91-b642-a744-0ab7-3e00f9832b7e"
          data-animation-type="lottie"
          data-src="https://assets.website-files.com/61e5bb75ba3a7e40020bd3b2/620a95bf9ede664b27335e16_shape1_pink.json"
          data-loop="1"
          data-direction="1"
        ...
        <div
          data-w-id="425061fe-879e-1ec9-d3f1-f381c466b000"
          data-animation-type="lottie"
          data-src="https://assets.website-files.com/61e5bb75ba3a7e40020bd3b2/620a96ef46edaf416d112404_shape1_purple%20light.json"
          data-loop="1"
          data-direction="1"
      ...
      <div class="w-layout-grid main-grid">
        <div
          ...
          class="center-wrapper inner-padding-medium"
        >
          <h2 class="heading-large margin-bottom-xsmall">Agenda.</h2>
          <p class="medium-paragraph">
            A stellar roster of design and product leaders to share their
            journeys and experiences with the community.
          </p>
        </div>
      </div>
      <div class="rounded-box">
        <div class="w-layout-grid main-grid">
          <div id="w-node-_54adcaaa-0454-a003-4d72-1777ed4c39cb-0e305478">
            <div class="date-spot">
              <div class="heading-small">Day 01</div>
              <div class="heading-small">July 30</div>
            </div>
          </div>
            ...
            <div class="faq-wrapper divider">
              <a
                ...
                ><div>
                  <div class="timeline-wrapper">
                    <div class="text-date bg-color">9:00 AM</div>
                    <div class="text-date bg-color">9:30 AM</div>
                  </div>
              ...
              <div class="faq-container" style="display: none">
                ...
                <div class="content-wrapper inner-padding-micro">
                  <div class="w-layout-grid auto-grid profile">
                    <div class="square-profile">
                      <img
                        ...
                        "
                        src="/assets/61e5bb75ba3a7e25e50bd527_isolated-shot-joyful-blonde-young.jpg"
                        loading="lazy"
                        alt=""
                        class="cover-image"
                      />
                    ...
                    <div>
                      <div class="main-paragraph bold">Jessica Walsh</div>
      ...
      <div class="rounded-box">
        <div class="w-layout-grid main-grid">
          <div id="w-node-_2d0f1c9c-dc16-efae-8d6d-9e615d87816b-0e305478">
            <div class="date-spot">
              <div class="heading-small">Day 01</div>
              <div class="heading-small">July 30</div>
            </div>
          </div>
          <div id="w-node-_2d0f1c9c-dc16-efae-8d6d-9e615d878171-0e305478">
            <div class="faq-wrapper divider">
              <a
                href="https://friday-template.webflow.io/landing/01#"
                class="faq-link w-inline-block"
